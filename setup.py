...
setup(
    ...
    packages=[
        "masonite_commerce",
        "masonite_commerce.commands",
        "masonite_commerce.config",
        "masonite_commerce.enums",
        "masonite_commerce.migrations",
        "masonite_commerce.models",
        "masonite_commerce.providers",
        "masonite_commerce.queries",
        "masonite_commerce.routes",
        "masonite_commerce.validators",
    ],
    package_dir={"": "src"},
